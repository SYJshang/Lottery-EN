...
@interface SYJPowerballController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SYJPowerballController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
        ...
        SYJPowerDeatilCell *cell = [SYJPowerDeatilCell cellWithTableView:tableView];
