...
@interface SYJHotDetailController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SYJHotDetailController
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    self.navigationItem.titleView = [UILabel titleWithColor:[UIColor grayColor] title:self.gameName font:scaleWithSize(24)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SYJHotDeailCell *cell = [SYJHotDeailCell cellWithTableView:tableView];
