...
@interface SYJTwoByController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SYJTwoByController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SYJTwoCell *cell = [SYJTwoCell cellWithTableView:tableView];
